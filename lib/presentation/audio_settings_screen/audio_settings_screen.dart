        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              SizedBox(height: 2.h),
              Text('• Mikrofon-Empfindlichkeit: 70%',
                  style: AppTheme.lightTheme.textTheme.bodySmall),
              Text('• Rauschunterdrückung: Aktiviert',
                  style: AppTheme.lightTheme.textTheme.bodySmall),
              Text('• Aufnahmemodus: Kontinuierlich',
                  style: AppTheme.lightTheme.textTheme.bodySmall),
              Text('• Lautstärke: 80%',
                  style: AppTheme.lightTheme.textTheme.bodySmall),
              Text('• Abtastrate: 44.1kHz',
                  style: AppTheme.lightTheme.textTheme.bodySmall),
              Text('• Komprimierung: Mittel',
                  style: AppTheme.lightTheme.textTheme.bodySmall),
            ],
          ),
          actions: [
            ...
            child: Column(
              ...
              children: [
                ...
                _buildUsageIndicator(
                    'Akku-Verbrauch', 0.6, AppTheme.warningLight),
                SizedBox(height: 1.h),
                _buildUsageIndicator(
                    'Datenverbrauch', 0.4, AppTheme.successLight),
                SizedBox(height: 1.h),
                _buildUsageIndicator(
                    'Speicherplatz', 0.3, AppTheme.successLight),
                SizedBox(height: 2.h),
                Text(
                  'Empfehlungen:',
                  style: AppTheme.lightTheme.textTheme.titleMedium,
                ...
                SizedBox(height: 1.h),
                Text('• Reduzieren Sie die Abtastrate für längere Akkulaufzeit',
                    style: AppTheme.lightTheme.textTheme.bodySmall),
                Text(
                    '• Aktivieren Sie Komprimierung für geringeren Datenverbrauch',
                    style: AppTheme.lightTheme.textTheme.bodySmall),
                Text('• Push-to-Talk spart Akku bei seltener Nutzung',
                    style: AppTheme.lightTheme.textTheme.bodySmall),
              ],
            ),
          ),
